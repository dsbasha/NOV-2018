...
dt = tree.DecisionTreeClassifier(criterion = 'entropy', max_depth=10, min_samples_split=5)
...
X_test.to_csv("Submission_Attempt4.csv", columns=['PassengerId', 'Survived'], index=False)
