# -*- coding: utf-8 -*-
"""
Created on Sat Dec 22 12:08:12 2018
...
rf_grid = {'n_estimators':[25,30], 'max_features':[10, 15, 20], 'max_depth':[4,6,8], 'min_samples_split':[2,3,4]}
grid_rf_estimator = model_selection.GridSearchCV(rf_estimator, rf_grid, cv=10, n_jobs=2)
